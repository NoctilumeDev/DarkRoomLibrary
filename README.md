...
**在线演示（支持移动端）：** [在浏览器体验六个固定权限身份](https://noctilumedev.github.io/DarkRoomLibrary/)
...
| 验证维度 | v1.2.7 当前维护基线与 v1.2.4 / v1.2.3 历史证据 |
| --- | --- |
| 自动测试 | 后端 `290/290`，行覆盖率 `72.49%`；前端 `70/70`，关键逻辑范围行覆盖率 `74.81%`，ESLint、构建和 npm 审计通过 |
