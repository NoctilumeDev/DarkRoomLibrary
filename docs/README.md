...
4. 需要了解形成过程时查看两份起源材料，需要总结工程和个人方法时查看两份复盘材料。
...
5. 查看 [数据库初始化说明](../sql/README.md) 与 `init-dark-room-library.sql`。
...
| `暗室藏书_项目想法起源.pdf` | 说明命名、阅读氛围、角色秩序和功能构想的来源 | 答辩、设计交流 |
| `暗室藏书项目复盘.pdf` | 总结业务、架构、验证、文档、Git 与发布治理 | 答辩、维护者 |
| `暗室藏书项目个人复盘.pdf` | 以控制变量为主线保留阶段性工具比较、个人判断和迭代过程；其中版本与测试数字是当时快照，最终事实以 `verification-report.md` 为准 | 个人总结、答辩 |
...
- 个人复盘保留阶段性实验语境，不作为最终技术版本、测试数字或项目起点的权威来源。
