...
截至 2026-08-28，当前公开版本为 v1.2.7：Spring Boot 3.5.16、Vue 3.5.40、Vite 8.1.5，后端端口 `20606`、前端端口 `5175`。后端 `290/290`、前端 `68/68` 通过；6 个固定权限身份于 v1.2.4 完成 70 次页面 API 全链路，独立并发套件于 v1.2.4 完成 20 个场景、393 次请求；三个后端实例的 8 个一致性场景、176 次请求保留为 v1.2.3 历史基线。最新浏览器诊断完成 116 个路由、456 次 API 和 6,114 次网络响应，Console、失败请求与横向溢出均为 0。详情见 [`verification-report.md`](verification-report.md) 与 [`architecture-review.md`](architecture-review.md)。
